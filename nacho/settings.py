"""
Django settings for nacho project.
...
GOOGLE_ANALYTICS_STREAM_ID = os.environ.get("GOOGLE_ANALYTICS_STREAM_ID")
...
SECRET_KEY = 'django-insecure-nd@)zi=s05_2g6gs+w-l6zj-c@tf_%9wknvk=5s0$kzh#w31to'
...
ROOT_URLCONF = 'nacho.urls'

STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR,'nacho','static')]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'nacho.context_processors.google_analytics',
            ],
        },
    },
]
